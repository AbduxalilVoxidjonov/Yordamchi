...
public enum PdfErrorKind
{
    ...
    /// <summary>Berilgan parol noto'g'ri.</summary>
    InvalidPassword,

    /// <summary>Zarur komponent topilmadi: OCR til fayli, ONNX modeli, Microsoft Word va h.k.</summary>
    MissingComponent,

    /// <summary>Fayl formati bu operatsiya uchun mos emas (masalan .doc o'rniga .docx kutilgan).</summary>
    UnsupportedFormat,

    /// <summary>Foydalanuvchi kiritgan sozlama noto'g'ri (masalan sahifa oralig'i xato yozilgan).</summary>
    InvalidOptions,

    /// <summary>Operatsiya boshlandi, lekin yakuniga yetmadi.</summary>
    OperationFailed
}
